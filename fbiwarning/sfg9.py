...
class Sphere:
    ...
    def create_disk_vertices(self):
        ...
        for i in range(num_segments + 1):
            ...
            tex_coords.extend([(x / self.disk_radius) * 0.5 + 0.5, (z / self.disk_radius) * 0.5 + 0.5])
        ...
        for i in range(num_segments):
            ...
            vertices.extend([vertices[3*top_curr], vertices[3*top_curr+1], vertices[3*top_curr+2],
                             vertices[3*bottom_curr], vertices[3*bottom_curr+1], vertices[3*bottom_curr+2],
                             vertices[3*bottom_next], vertices[3*bottom_next+1], vertices[3*bottom_next+2],
                             vertices[3*top_next], vertices[3*top_next+1], vertices[3*top_next+2]])
            normals.extend([vertices[3*top_curr], 0, vertices[3*top_curr+2]] * 4)
...
class Window(pyglet.window.Window):
    def __init__(self, width, height, title='Pyglet Sphere'):
        ...
        self.sphere = Sphere(2.0, 40, 40, 6, 0.25)
