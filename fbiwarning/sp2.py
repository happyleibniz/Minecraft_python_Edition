...
class Sphere:
    ...
    def create_disk_vertices(self):
        ...
        for i in range(num_segments + 1):
            ...
            # Set the whirlpool effect area to white
            tex_coords.extend([1.0, 1.0] if u > 1.0 or v > 1.0 else [u, v])
    ...
    def draw(self):
        ...
        glColor3f(1.0, 1.0, 1.0)  # Set color to white for the whirlpool effect area
